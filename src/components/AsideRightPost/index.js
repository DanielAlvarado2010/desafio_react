        ...
        <div className="p_card rounded-3 mb-3">
            <ul className="list-group list-group-flush">
                <li className="list-group-item">
                    <div>
                        <img src="../img/avatar.jpeg" className="border border-light border border-1 rounded-circle avatar" alt="..."/>
                        <a href="#"><span className="names_r pb-3" id="userNameRight"></span></a>
                    </div>
                    ...
                    <div className="p_card2 rounded-3">
                        <ul className="list-group list-group-flush">
                            <li className="list-group-item names_r">More from <a href="#">Nitin Ranganath</a></li>
