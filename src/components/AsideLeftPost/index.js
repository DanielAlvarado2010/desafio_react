import "./AsideLeftPost.css";

import React from "react";

function AsaideLeftPost({reaction, unicorn, comment}) {
    return (
        <div className="columna">
            <div className="left-item pb-3">
                ...
                <p className="numbers" id="reactions">
                    {reaction}
                </p>
            </div>
            <div className="left-item pb-3">
                ...
                <p className="numbers" id="unicorns">
                    {unicorn}
                </p>
            </div>
            <div className="left-item pb-3">
                ...
                <p className="numbers" id="comments">
                    {comment}
                </p>
            </div>
            <div className="left-item pb-3">
